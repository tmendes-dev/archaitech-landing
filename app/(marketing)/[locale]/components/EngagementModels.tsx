  ...
  return (
    <section id="engagement" className="mx-auto max-w-6xl px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="mt-8 grid md:grid-cols-3 gap-6">
        {items?.map((it, i) => (
          <article key={i} className="rounded-2xl border border-slate-200 dark:border-slate-800 p-6 bg-white dark:bg-slate-900 shadow-sm hover:shadow-md transition-shadow h-full">
